...
RMF 的 “评估” 步骤，旨在确定系统中的控制措施在应用过程中是否有效，以及能否产生预期结果。NIST SP 800-53A 【[SP800-53Ar5](./refs.md#sp800-53ar5)】 为评估 NIST SP 800-53 中选定的控制措施提供了指导，以确保这些控制措施得到正确实施、按预期运行，并能产生预期结果，从而满足系统的安全要求。

下 [表 10](#t-10) 提供了将 “评估” 步骤应用于 OT 的更多细节。

<a name="t-10"></a>
**表 10**： 应用 RMF 的 “评估” 步骤于 OT


| 任务 | 成果 | 特定于 OT 的指南 |
| :- | :- | :- |
| TASK A-1 评估员遴选 | 遴选一名评估员或评估小组来开展控制评估。所选评估员或评估团队应具备适当的独立性。| 评估团队中应包含 OT 系统人员和操作员。 |
| TASK A-2 评估计划 | 向评估员或评估团队提供开展评估所需的文件。制定并记录安全与隐私评估计划。审查并批准安全与隐私评估计划，以确立对控制评估的预期及所需的工作量。 | |
| TASK A-3 | 控制评估 | 控制评估应按照安全和隐私评估计划进行。应考虑复用以往评估的结果，以确保风险管理流程及时且经济高效。应最大限度地利用自动化手段开展控制评估，以提高评估的速度、有效性和效率。| 考虑采用桌面演练或模拟演练，以减少对生产运营技术（OT）系统的影响。使用自动化工具进行评估时需谨慎操作，以确保 OT 系统不会因测试过程而受到不利影响。 |
| TASK A-4 评估报告 | 完成包含评估结果和建议的安全与隐私评估报告。<br />[*网络安全框架*：**ID.RA-1** 和 **ID.RA-3**] | |
| TASK A-5 整改措施 | 采取整改措施，以解决系统和运行环境中已实施控制措施存在的缺陷。更新安全和隐私计划，以反映根据评估及后续整改措施所做的控制实施变更。<br />[*网络安全框架*：**Profile**] | 确保整改措施不会对 OT 的效率和安全运行产生负面影响。考虑将补偿性控制措施作为整改措施之一。 |
| TASK A-6 行动计划与里程碑 | 制定行动计划与里程碑，详细说明针对安全与隐私评估报告中识别出的不可接受风险所采取的整改方案。<br />[*网络安全框架*：**ID.RA-6**] | 在制定行动计划与里程碑时，应考虑 OT 系统的独特时间限制，并兼顾 OT 系统的计划性维护或停机安排。 |

### 授权

“授权”步骤涉及管理层基于已实施的一套商定控制措施，对系统运行作出授权决策，并明确接受该系统对运营、资产及人员带来的风险。新系统在获得授权之前不得投入生产或运行。

下 [表 11](#t-11) 提供了将 “授权” 步骤应用于 OT 的更多细节。

<a name="t-11"></a>
**表 11**：应用 RMF 的 “授权” 步骤于 OT


| 任务 | 成果 | 特定于 OT 的指南 |
| :- | :- | :- |
| TASK R-1 授权文件包 | 编制一份授权文件包，提交给授权官员。 | |
| TASK R-2 风险分析与判定 | 授权官员作出风险判定，该判定应体现风险管理策略，包括风险容忍度。| |
| TASK R-3 风险应对 | 针对已确定的风险提供风险应对措施。<br />[*网络安全框架*：**ID.RA-6**]  | 制定并实施一项全面的运营技术（OT）系统风险管理策略，其中包括识别风险应对措施并确定其优先级。 |
| TASK R-4 授权决策 | 批准或拒绝针对系统或通用控制措施的授权。 | 当系统风险超出可接受范围时，组织可能需要制定整改策略，同时需考虑 OT 特有的依赖关系，例如在问题得到解决之前无法将系统或组件下线。 |
| TASK R-5 授权报告 | 将授权决定、重大漏洞和风险报告给组织负责人。 | 确保将相关决定、漏洞和风险报告给 OT 和运维人员。 |

### 监控

“监控” 步骤旨在持续跟踪可能影响控制措施的系统变更，并评估控制措施的有效性。NIST SP 800-37 第 2 版（Rev. 2）提供了关于网络安全持续监控的指导 【[SP800-37r2](./refs.md#sp800-37r2)】。

下 [表 12](#t-12) 详细介绍了将 “监控” 步骤应用于运营技术（OT）的相关内容。

<a name="t-12"></a>
**表 12**：应用 RMF 的监控步骤于运营技术（OT）

| 任务 | 成果 | 特定于 OT 的指导 |
| :- | :- | :- |
| TASK M-1 系统与环境变更 | 根据持续监控策略对运营系统和环境进行监控。<br />[*网络安全框架*：**DE.CM**；**ID.GV**]  | 采用针对 OT 的持续监控策略，该策略将性能影响和安全系统视为关键因素。 |
| TASK M-2 持续评估 | 根据持续监控策略，对控制措施的有效性进行持续评估。 <br />[*网络安全框架*：**ID.SC-4**] | 开展持续评估，并考虑系统性能和安全影响。 |
| TASK M-3 持续风险响应 | 对持续监控活动的结果进行分析并采取适当应对措施。<br />[*网络安全框架*：**RS.AN**] | 将检测到的事件信息与风险评估结果进行关联，以全面了解事件对运营技术（OT）系统的影响。 |
| TASK M-4 授权文件更新 | 根据持续监控活动更新风险管理文件。<br />[*网络安全框架*：**RS.IM**] | |
| TASK M-5 安全与隐私报告 | 已建立向授权官员及其他高级领导和高管，报告安全与隐私状况的流程。 | |
| TASK M-6 持续授权 | 授权官员利用持续监测活动的结果进行持续授权，并通报风险判定和风险接受决策的变更。 | |
| TASK M-7 系统处置 | 根据需要制定并实施系统处置策略。 | IT 组件中发现的计划性淘汰可能不适用于 OT 组件。应考虑对那些需要维持运行时间超过 IT 组件可用周期的 OT 组件，进行维护和维修。 |
