...
| :- | :- | :- |
| 组织和使命以及业务流程级别 |||
| TASK P-1 风险管理角色 | 确定并分配个人以执行 RMF 的关键角色。 [*网络安全框架*：**ID.AM-6**； **ID.GV-2**] [*IEC 62443-2-1*：**ORG 1.3**] | 建立和维护 IT 和 OT 系统的人员网络安全角色和职责。包括第三方提供商的网络安全角色和责任。OT 示例人员包括工艺/工厂经理、工艺控制工程师、操作员、功能安全工程师、维护人员和工艺安全经理。 |
| TASK P-2 风险管理策略 | 建立组织的风险管理策略，其中包括组织风险承受能力的确定和表述。| [*网络安全框架*：**ID.RM**；**ID.SC**] [IEC 62443-2-1：**ORG 2.1**] | 风险管理策略涵盖整个组织。考虑与有着 OT 系统的组织相关的独特监管要求。 |
